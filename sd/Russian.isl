...
; *** SetupLdr messages
SetupLdrStartupMessage=Данная программа установит SD-модели «Мир Танков Истоки» на ваш компьютер, продолжить?
...
ExitSetupMessage=Установка не завершена. Если вы выйдете, SD-модели не будут установлены.%n%nВы сможете завершить установку, запустив программу установки позже.%n%nВыйти из программы установки?
...
; *** "Welcome" wizard page
WelcomeLabel1=Вас приветствует Мастер установки SD-моделей%n«Мир Танков Истоки»
WelcomeLabel2=Программа установит SD-модели «Мир Танков Истоки» для «Мира Танков».%n%nРекомендуется закрыть клиент игры перед тем, как продолжить.
...
SelectDirDesc=Где находится клиент игры, на который вы хотите установить SD-модели%n«Мир Танков Истоки»?
SelectDirLabel3=Программа установит SD-модели «Мир Танков Истоки» по следующему пути.
...
SelectTasksLabel2=Выберите дополнительные задачи, которые должны выполниться при установке SD-моделей «Мир Танков Истоки», после этого нажмите «Далее»:
...
ReadyLabel1=Программа установки готова начать установку SD-моделей «Мир Танков Истоки» для вашей игры.
...
PreparingDesc=Программа установки подготавливается к установке SD-моделей «Мир Танков Истоки» на ваш компьютер.
PreviousInstallNotCompleted=Установка или удаление предыдущей программы не были завершены. Вам потребуется перезагрузить компьютер, чтобы завершить ту установку.%n%nПосле перезагрузки запустите вновь Программу установки, чтобы завершить установку SD-моделей «Мир Танков Истоки».
...
PrepareToInstallNeedsRestart=Программе установки требуется перезагрузить ваш компьютер. Когда перезагрузка завершится, пожалуйста, запустите программу установки вновь, чтобы завершить процесс установки SD-моделей «Мир Танков Истоки».%n%nПроизвести перезагрузку сейчас?

; *** "Installing" wizard page
WizardInstalling=Установка...
InstallingLabel=Пожалуйста, подождите, пока SD-модели «Мир Танков Истоки» установятся на вашу игру.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Завершение Мастера установки SD-модели «Мир Танков Истоки»
FinishedLabelNoIcons=SD-модели «Мир Танков Истоки» установлены на ваш клиент игры.
FinishedLabel=SD-модели «Мир Танков Истоки» установлены на ваш клиент игры. Её можно запустить с помощью соответствующего значка.
ClickFinish=Нажмите «Завершить», чтобы выйти из программы установки.
FinishedRestartLabel=Для завершения установки SD-моделей «Мир Танков Истоки» требуется перезагрузить компьютер. Произвести перезагрузку сейчас?
FinishedRestartMessage=Для завершения установки SD-моделей «Мир Танков Истоки» требуется перезагрузить компьютер.%n%nПроизвести перезагрузку сейчас?
...
UninstallOnlyOnWin64=Данные моды возможно деинсталлировать только в среде 64-битной Windows.
OnlyAdminCanUninstall=Эти моды могут быть деинсталлированы только пользователем с административными привилегиями.
UninstallStatusLabel=Пожалуйста, подождите, пока моды %1 будут удалены с вашего компьютера.
UninstalledAll=Моды %1 были полностью удалены с вашего компьютера.
