...
ExitSetupMessage=Setup is not complete. If you exit now, the mods will not be installed.%n%nYou may run Setup again at another time to complete the installation.%n%nExit Setup?
...
WizardSelectDir=Select Game Cleint Location
SelectDirDesc=Where is the game client which you want [name]%nto be installed to located?
...
SelectComponentsDesc=Which mods should be installed?
SelectComponentsLabel2=Select the mods you want to install; clear the mods you do not want to install. Click Next when you are ready to continue.
FullInstallation=Full installation
; if possible don't translate 'Compact' as 'Minimal' (I mean 'Minimal' in your language)
CompactInstallation=Compact installation
CustomInstallation=Custom installation
NoUninstallWarningTitle=Components Exist
NoUninstallWarning=Setup has detected that the following mods are already installed on your computer:%n%n%1%n%nDeselecting these mods will not uninstall them.%n%nWould you like to continue anyway?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
...
ReadyMemoDir=Game client location:
ReadyMemoType=Setup type:
ReadyMemoComponents=Selected mods:
...
PreparingDesc=Setup is preparing to install [name] on your game client.
...
InstallingLabel=Please wait while Setup installs [name] on your game client.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Completing the [name] Setup Wizard
FinishedLabelNoIcons=Setup has finished installing [name] on your game client.
FinishedLabel=Setup has finished installing [name] on your game client. It may be launched by selecting the installed shortcuts.
