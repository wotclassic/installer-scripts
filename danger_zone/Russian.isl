...
ExitSetupMessage=Установка не завершена. Если вы выйдете, мод не будет установлен.%n%nВы сможете завершить установку, запустив программу установки позже.%n%nВыйти из программы установки?
...
; *** "Welcome" wizard page
WelcomeLabel1=Вас приветствует Мастер установки мода [name]
WelcomeLabel2=Программа установит мод [name] для «Мира Танков».%n%nРекомендуется закрыть клиент игры перед тем, как продолжить.
...
SelectDirDesc=Где находится клиент игры, на который вы хотите установить мод%n[name]?
SelectDirLabel3=Программа установит мод [name] по следующему пути.
...
SelectTasksLabel2=Выберите дополнительные задачи, которые должны выполниться при установке мода [name], после этого нажмите «Далее»:
...
ReadyLabel1=Программа установки готова начать установку мода [name] для вашей игры.
...
InstallingLabel=Пожалуйста, подождите, пока мод [name] установится на вашу игру.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Завершение Мастера установки мода [name]
FinishedLabelNoIcons=Мод [name] установлен на ваш клиент игры «Мир Танков».
FinishedLabel=Мод [name] установлен на ваш клиент игры «Мир Танков». Игру можно запустить с помощью соответствующего значка.
...
UninstallOnlyOnWin64=Данный мод возможно деинсталлировать только в среде 64-битной Windows.
OnlyAdminCanUninstall=Этот мод может быть деинсталлирован только пользователем с административными привилегиями.
UninstallStatusLabel=Пожалуйста, подождите, пока мод %1 будет удалён с вашего компьютера.
UninstalledAll=Мод %1 был полностью удалён с вашего компьютера.
