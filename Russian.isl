...
ExitSetupMessage=Установка не завершена. Если вы выйдете, моды не будут установлены.%n%nВы сможете завершить установку, запустив программу установки позже.%n%nВыйти из программы установки?
...
WelcomeLabel2=Программа установит моды [name] для «Мира Танков».%n%nРекомендуется закрыть клиент игры перед тем, как продолжить.
...
FinishedLabelNoIcons=Моды [name] установлены на ваш клиент игры «Мир Танков».
FinishedLabel=Моды [name] установлены на ваш клиент игры «Мир Танков». Игру можно запустить с помощью соответствующего значка.
